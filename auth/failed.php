<?php
    ...
    echo '<script>alert("Payment is Failed");</script>';

    echo "<center><h5 class='mt-3'>Go Back To Donate Page <a href='https://fundmenaija.com/auth/donate.php'>  Click Here</a></h5></center>";
...
<body>
    <section class="container shadow-sm py-3">
        <div class="bg-danger py-2 head text-center px-5" style="font-size: 1.5em; font-weight: 500;">
            <p class="text-light ">Your Payment was NOT successful.</p>
        </div>
        <div class="fund text-light text-center py-5" style="background:  rgb(4, 4, 63); font-size: 1.8em; font-weight: 600;">
            ...
            <p class="price" style="font-size:2em; font-weight: bolder;">NGN 0,000.00</p>
        </div>
