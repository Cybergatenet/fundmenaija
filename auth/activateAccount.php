...
<html lang="en">
  <head>
    ...
    <title>FundMeNaija | Activate Account</title>
    <!-- Font awesome -->
        ...
        <div class="container d-flex justify-content-between align-items-center py-2 px-lg-5">
                    ...
                    <ul class="list-unstyled desktop">
                        <div class="d-flex align-items-center">
                            <li><a href='./about.php' class='nav-link text-dark mx-lg-2 py-2 px-3' id='nav-link'>About</a></li>
                            <li><a href='./donate.php' class="nav-link text-dark mx-lg-2 py-2 px-3" id='nav-link'>Donate</a></li>
                            <li><a href='./contact.php' class="nav-link text-dark mx-lg-2 py-2 px-3" id='nav-link'>Contact</a></li>
                            <?php 
                    ...
                    <ul class="mobile">
                        <div class="d-flex font-weight-bold border-top">
                            <li><a href='./about.php' class='nav-link my-3 text-white'>About</a></li>
                            <li><a href='./contact.php' class='nav-link my-3 text-white'>Contact</a></li>
                            <li><a href='./donate.php' class='nav-link my-3 text-white'>Donate</a></li>
                            <?php 
                                if(isset($_SESSION['username']) || isset($_SESSION['AccountNo']) || isset($_SESSION['accountNo'])){
        ...
        <div style="margin: 130px auto 20px" class="col-md-6">
            <form id="form" class="form-group px-lg-5 p-4 shadow bg-white">
                <div class='text-center'>
                    <b class='text-dark text-uppercase h4'>Complete Your Sign up</b>
                </div>

                <div class="alert alert-success text-center h5 mb-0 mt-3">Donate to Activate Your Account...!
                </div>
