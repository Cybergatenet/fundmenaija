        ...
        if (mysqli_num_rows($result) > 0) {
                    ...
                    <div class="col-sm-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                To Complete this process, you are required to make a deposit into your account to activate it.
                                You Have Successfully send your request Application, but Your request verificaton is in progress. This Process usually take less than 24hours. <a class="btn btn-success p-1" href="mailto:contact@fundmenaija.com">Contact Us</a>, if you experience any difficulties. </p>
            <form id="form" class="form-group px-lg-5 p-4 shadow bg-white">
                ...
                <input 
                    ...
                    required
                >
                <input type="hidden" id="email" value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : 'pureinsightstrategyltd@gmail.com'; ?>">
                <br>
            ...
            <!-- <div class="card-body">
                ...
                <p class="card-text pl-2 pr-2"> &emsp; 
                To Complete this process, you are required to make a deposit into your account to activate it.
                You Have Successfully send your request Application, Your request verificaton is in progress. This Process usually take less than 24hours. <a hraf="mailto: contact@fundmenaija.com">Contact Us</a>, if you experience any difficulties. </p>
